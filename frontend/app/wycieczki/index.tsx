...
export default function WycieczkiIndex() {
  ...
  // Sort: NUMBER ONE first, then BESTSELLER last
...
const styles = StyleSheet.create({
  ...
  heroTitle: { color: "#fff", fontSize: 30, fontWeight: "900", lineHeight: 34, textShadowColor: "rgba(0,0,0,0.5)", textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 8 },
