  ...
  if (!trip) {
    return (
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
        ...
        <TouchableOpacity onPress={() => router.push("/wycieczki")}>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fafafa" }}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.priceBar}>
          <View>
            ...
            <Text style={[styles.priceValue, { color: trip.accent }]}>
              {trip.price} zł <Text style={styles.priceUnit}>/os</Text>
            </Text>
          </View>
      ...
      <SafeAreaView edges={["bottom"]} style={styles.ctaBar}>
        <TouchableOpacity
          activeOpacity={0.85}
          style={[styles.ctaBtn, { backgroundColor: trip.accent }]}
...
const styles = StyleSheet.create({
  ...
  heroOverlay: { position: "absolute", inset: 0, top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(0,0,0,0.45)" },
  ...
  heroTitle: { color: "#fff", fontSize: 24, fontWeight: "800", lineHeight: 28, marginBottom: 6, textShadowColor: "rgba(0,0,0,0.5)", textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 8 },
