...
export const TRIPS: Trip[] = [
  // 1. PIENINY
  {
    ...
    included: ["Transport prywatny Toyotą Prius (tam i z powrotem)", "Kierowca-przewodnik", "Czekanie podczas zwiedzania", "Pomoc w zakupie biletów", "Rekomendacje knajp"],
  ...
  // 2. DUNAJEC
  {
    ...
    included: ["Transport prywatny Toyotą Prius (tam i z powrotem)", "Kierowca-przewodnik", "Pomoc w zakupie biletów", "Transfer z mety spływu"],
  ...
  // 3. SLOWACJA - NUMBER ONE
  {
    ...
    included: ["Transport prywatny Toyotą Prius tam i z powrotem (Polska→Słowacja)", "Kierowca-przewodnik", "Czekanie podczas zwiedzania", "Pomoc w zakupie biletów", "Przekroczenie granicy + opłaty drogowe"],
  ...
  // 4. WODOSPADY
  {
    ...
    included: ["Transport prywatny Toyotą Prius tam i z powrotem (Polska→Słowacja)", "Kierowca-przewodnik", "Pomoc w zakupie biletów", "Przekroczenie granicy + opłaty drogowe"],
  ...
  // 5. ZAKOPANE
  {
    ...
    included: ["Transport prywatny Toyotą Prius (tam i z powrotem)", "Kierowca-przewodnik", "Czekanie podczas zwiedzania", "Pomoc w zakupie biletów", "Rezerwacja stolika w karczmie"],
