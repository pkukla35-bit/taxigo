...
export const TRIPS: Trip[] = [
  ...
  // 3. SLOWACJA - NUMBER ONE
  {
    ...
    subtitle: "Bachledova • Strbskie Pleso • Jaskinia Bielańska",
    ...
    attractions: [],
    timeline: [
      { time: "06:00", icon: "🚗", title: "Wyjazd z Krakowa", description: "Trasa: Kraków → Zakopane → Jurgów → Słowacja (Tatrzańska Biela)" },
      { time: "08:30", icon: "🦇", title: "Jaskinia Bielańska (Belianska jaskyňa)", description: "Trasa 1370 m, ~70 min zwiedzania, ponad 800 schodów, stalaktyty, draperie, jeziora (5-6°C — zabierz bluzę)" },
      { time: "11:00", icon: "⛰️", title: "Bachledova + Chodnik w Koronach", description: "Spacer w koronach drzew, wieża panoramiczna (~2h)" },
      { time: "14:00", icon: "💎", title: "Szczyrbskie Pleso", description: "Spacer wokół jeziora, kawa z widokiem (~1.5h)" },
      { time: "16:00", icon: "🏠", title: "Powrót do Krakowa", description: "Przyjazd ~19:30-20:30" },
    ],
    mapImage: "/trip3-map.png",
    mapLegend: "1. Jaskinia Bielańska • 2. Bachledova • 3. Szczyrbskie Pleso",
